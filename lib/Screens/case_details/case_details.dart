      ...
      children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    TextConstant(
                      title: controller.caseDetails?.labcenter?.name ?? "",
                      fontSize: 15.0,
                      color: AppColor.primary,
                      fontWeight: FontWeight.bold,
                    ),
                    TextConstant(
                      title:
                          (controller.caseDetails?.labcenter?.contactNumbers ??
                                  [])
                              .join(",\n"),
                      fontSize: 13.0,
                    ...
                    TextConstant(
                      title: controller.caseDetails?.labcenter?.location ?? "",
                          ...
                          children: [
                            ...
                            TextConstant(
                              title: controller.getFullAddress(
                                controller.caseDetails?.patient?.address,
                              ),
                              fontSize: 13.0,
                              color: AppColor.greycolor,
                            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            TextConstant(
                              title: "#${controller.caseDetails?.caseId}",
                              fontWeight: FontWeight.bold,
                            ),
                            Spacer(),
                            TextConstant(
                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    ...
                    rows: [
                      ...
                      for (
                        int i = 0;
                        i < (controller.selectedGroupTests ?? []).length;
                        i++
                      )
                        DataRow(
                          cells: [
                            ...
                            DataCell(
                              Text(
                                controller.selectedGroupTests[i].groupId ?? "",
                                style: TextStyle(
                                  fontSize: 13.h,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.black45,
                            ...
                            DataCell(
                              SizedBox(
                                child: Text(
                                  (controller.selectedGroupTests[i].tests ?? [])
                                      .map((e) => e.name ?? "")
                                      .join(" , "),
                                  style: TextStyle(
                                    fontSize: 13.h,
        ...
        SingleChildScrollView(
          ...
          child: DataTable(
            ...
            rows: (controller.caseDetails?.transactions ?? []).map((tx) {
              return DataRow(
                cells: [
