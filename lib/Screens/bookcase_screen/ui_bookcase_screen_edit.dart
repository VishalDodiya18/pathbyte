...
import 'package:pathbyte/Screens/bookcase_screen/selected_test_datatable.dart';
import 'package:pathbyte/Screens/bookcase_screen/selected_test_datatable_edit.dart';
...
import 'package:pathbyte/bottomsheets/test_seelction_sheet.dart';
...
class EditBookCaseScreen extends StatelessWidget {
  EditBookCaseScreen({super.key});
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              GetBuilder<EditBookCaseController>(
                                builder: (cc) {
                                  return Container(
                                    padding: EdgeInsets.symmetric(
                                      horizontal: 10.0,
                          ...
                          heightBox(18),
                          EditSelectedTestsTable(),
                          heightBox(20),
                          GestureDetector(
                            onTap: () {
                              showTestBottomSheet2(context);
                            },
                            child: const Padding(
                            ...
                            builder: (bcontroller) {
                              return Column(
                                children: [
                                  ...
                                  //   false,
                                  //   iswidget: true,
                                  //   customwidget: GetBuilder<EditBookCaseController>(
                                  //     builder: (contrller) {
                                  //       return Padding(
                                  //         padding: const EdgeInsets.only(
                                  //           left: 15.0,
