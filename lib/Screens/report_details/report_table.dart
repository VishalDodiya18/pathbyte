                    ...
                    DataRow(
                      cells: [
                        ...
                        DataCell(
                          Center(
                            child: Text(
                              "${category.groupedTests?[i].caseTests?[j].characteristics?[k].appliedReferenceRange?.lowValue ?? ""} - ${category.groupedTests?[i].caseTests?[j].characteristics?[k].appliedReferenceRange?.highValue ?? ""} ",
                  ...
                  DataRow(
                    cells: [
                      ...
                      DataCell(
                        Center(
                          child: Text(
                            "${category.ungroupedTests?[i].characteristics?[j].appliedReferenceRange?.lowValue ?? ""} - ${category.ungroupedTests?[i].characteristics?[j].appliedReferenceRange?.highValue ?? ""} ",
                            textAlign: TextAlign.center,
                          ),
                        ),
                      ),
